...
export const ContentSection = () => {
  return (
    <section className="py-[160px] bg-vault-surface-elevated">
      <div className="container mx-auto px-6">
        <div className="text-center mb-[120px]">
          <h2 className="font-black uppercase tracking-tight leading-[0.95] text-vault-primary" style={{ fontSize: 'clamp(4rem, 8vw, 7rem)', letterSpacing: '-0.06em' }}>
        ...
        <div className="grid lg:grid-cols-2 gap-[100px] items-center mb-[140px]">
          <div className="order-2 lg:order-1">
            <img 
              ...
              className="rounded-[5px] w-full max-w-[650px] shadow-2xl"
            />
          </div>
          <div className="order-1 lg:order-2">
            <h3 className="font-black text-white mb-6 leading-[1.05]" style={{ fontSize: 'clamp(2.8rem, 4.5vw, 4rem)' }}>
              Beyond Simple Storage.
            </h3>
            <p className="text-vault-text-light leading-[1.6]" style={{ fontSize: 'clamp(1.35rem, 2vw, 1.8rem)' }}>
